...
const EditModal = ({ visible, onClose, field, value, onSave }) => {
        ...
        <View style={M.sheet}>
          ...
          <View style={M.row}>
            <TouchableOpacity style={M.cancelBtn} onPress={onClose}>
              <Text style={M.cancelT}>Cancel</Text>
            </TouchableOpacity>
            <TouchableOpacity style={M.saveBtn} onPress={() => { onSave(text); onClose(); }}>
              <LinearGradient colors={[C.primary, C.primaryDark]} style={M.saveBtnInner}>
                <Text style={M.saveT}>Save</Text>
              </LinearGradient>
            </TouchableOpacity>
          </View>
        </View>
...
export default function ProfileScreen({ navigation }) {
  ...
  const saveEdit = (field, value) => {
    setUser(u => ({ ...u, [field.toLowerCase()]: value }));
  };
