...
const AVATARS = {
  A: ['#667EEA', '#764BA2'], S: ['#F093FB', '#F5576C'],
  K: ['#43E97B', '#38F9D7'], P: ['#FA709A', '#FEE140'],
  R: ['#4FACFE', '#00F2FE'], M: ['#A18CD1', '#FBC2EB'],
  D: ['#FD7C6E', '#FFC170'], V: ['#E8445A', '#C22040'],
  N: ['#0F3460', '#533483'], T: ['#2D6A4F', '#1B4332'],
};

const DEFAULT_POSTS = [
  { id:'d1',  author:'Arjun Mehta',  authorRoll:'21CSE4501', avatar:'A', imageUri:CAMPUS_IMGS[0],  gradIdx:null, description:'Graduation day — the moment we\'ve all been waiting for! 🎓 Four years of hard work, late nights, and unforgettable memories. So proud of our batch! #AdityaUniversity #Class2025', likes:142, liked:false, timeAgo:'2h ago',  tag:'Graduation',  isOwn:false },
  { id:'d2',  author:'Sneha Reddy',  authorRoll:'22ECE3302', avatar:'S', imageUri:CAMPUS_IMGS[1],  gradIdx:null, description:'Squad goals 🔥 College would be nothing without these people. Every laugh, every chai break — all with my favourites! ❤️ #SquadForLife #CollegeDays', likes:89, liked:false, timeAgo:'5h ago',  tag:'Friends',     isOwn:false },
  { id:'d3',  author:ME.name,        authorRoll:ME.rollNo,   avatar:ME.avatar, imageUri:null, gradIdx:0, description:'First day at Aditya University ✨ Walking into campus with butterflies but leaving with a family. This place changed me forever. 🏫💙 #NewBeginnings #AdityaVibes', likes:54, liked:true, timeAgo:'1d ago',  tag:'Personal',    isOwn:true  },
  { id:'d4',  author:'Kiran Babu',   authorRoll:'21CSE7701', avatar:'K', imageUri:CAMPUS_IMGS[2],  gradIdx:null, description:'Inter-college cricket tournament 🏏 We brought the trophy home!! CHAMPIONS! 🏆 #Cricket #AdityaSports #Champions', likes:203, liked:false, timeAgo:'2d ago',  tag:'Sports',      isOwn:false },
  { id:'d5',  author:'Priya Sharma', authorRoll:'22EEE5540', avatar:'P', imageUri:CAMPUS_IMGS[3],  gradIdx:null, description:'Late night in the library before finals 📚 The silence, the coffee cups — somehow this became home for a whole semester. 🥺 #StudyLife #LibraryNights', likes:67, liked:false, timeAgo:'3d ago',  tag:'Study Life',  isOwn:false },
  { id:'d6',  author:'Rohit Kumar',  authorRoll:'21ME2210',  avatar:'R', imageUri:CAMPUS_IMGS[4],  gradIdx:null, description:'Sunset from the rooftop of Block C 🌅 After a long day of labs and assignments, this view makes everything worth it. #Sunset #GoldenHour #CampusLife', likes:178, liked:false, timeAgo:'4d ago',  tag:'Campus',      isOwn:false },
  { id:'d7',  author:'Meera Nair',   authorRoll:'22ME1004',  avatar:'M', imageUri:CAMPUS_IMGS[5],  gradIdx:null, description:'Hackathon 2025 — 24 hours of pure madness 💻🔥 Sleep-deprived but absolutely worth it! #Hackathon2025 #TechLife #BuildFast', likes:95, liked:false, timeAgo:'5d ago',  tag:'Tech',        isOwn:false },
  { id:'d8',  author:'Divya Rao',    authorRoll:'22CSE1104', avatar:'D', imageUri:CAMPUS_IMGS[6],  gradIdx:null, description:'Cultural fest day 🎭🎶 The performances were absolutely mind-blowing! Our college really knows how to celebrate! #CulturalFest #Aditya2025', likes:134, liked:false, timeAgo:'6d ago',  tag:'Events',      isOwn:false },
  { id:'d9',  author:'Naveen Raj',   authorRoll:'21ECE3301', avatar:'N', imageUri:CAMPUS_IMGS[7],  gradIdx:null, description:'First lecture of the semester with the best professor we\'ve ever had 🙌 This is going to be an amazing year! #ClassroomVibes #Learning', likes:45, liked:false, timeAgo:'1w ago',  tag:'Study Life',  isOwn:false },
  { id:'d10', author:'Teja Varma',   authorRoll:'21ME0042',  avatar:'T', imageUri:null, gradIdx:7, description:'Three years into engineering and I\'ve finally found what I love ❤️ The late nights, the deadlines, the frustration — it all leads to growth. 💪 #EngineeringLife', likes:72, liked:false, timeAgo:'1w ago',  tag:'Personal',    isOwn:false },
  { id:'d11', author:'Sneha Reddy',  authorRoll:'22ECE3302', avatar:'S', imageUri:CAMPUS_IMGS[8],  gradIdx:null, description:'College convocation rehearsal 🎓 We\'ve been waiting for this day for so long! Next week, we officially become alumni ✨ #Convocation #Graduation', likes:118, liked:false, timeAgo:'1w ago',  tag:'Graduation',  isOwn:false },
  { id:'d12', author:'Arjun Mehta',  authorRoll:'21CSE4501', avatar:'A', imageUri:CAMPUS_IMGS[9],  gradIdx:null, description:'Group study session turned into the best evening ever 😂📚 These people make even revision fun! #StudyGroup #CollegeLife #Friends', likes:93, liked:false, timeAgo:'2w ago',  tag:'Friends',     isOwn:false },
  { id:'d13', author:'Kiran Babu',   authorRoll:'21CSE7701', avatar:'K', imageUri:CAMPUS_IMGS[10], gradIdx:null, description:'Morning fog on campus is unreal sometimes 🌫️ Woke up early for a 7AM lab and caught this view. Worth every lost minute of sleep 😍 #CampusBeauty', likes:156, liked:false, timeAgo:'2w ago',  tag:'Campus',      isOwn:false },
  { id:'d14', author:ME.name,        authorRoll:ME.rollNo,   avatar:ME.avatar, imageUri:CAMPUS_IMGS[11], gradIdx:null, description:'Tech symposium 2025! 🖥️✨ Our project got selected for the top 5 presentations. The hard work finally paid off! So grateful for my amazing team 🤝 #TechSymposium', likes:211, liked:false, timeAgo:'3w ago', tag:'Tech', isOwn:true },
  { id:'d15', author:'Priya Sharma', authorRoll:'22EEE5540', avatar:'P', imageUri:null, gradIdx:4, description:'Four years of memories, friendships, failures, victories, and growth. College has shaped me into who I am today. Forever grateful for every moment at Aditya ❤️ #ForeverAdityaian', likes:389, liked:false, timeAgo:'3w ago', tag:'Personal', isOwn:false },
];

// ─── AI MODERATION ────────────────────────────────────────────────────────────
const moderateContent = async ({ base64Image, mediaType, description }) => {
  try {
    const msgContent = [];
    if (base64Image) {
      msgContent.push({ type:'image', source:{ type:'base64', media_type: mediaType||'image/jpeg', data:base64Image } });
    }
    msgContent.push({
      type:'text',
      text:`You are a strict content moderator for a student campus memories app called Campix at Aditya University, India.
${description ? `Post caption: "${description}"` : ''}
${base64Image ? 'Also analyze the image above.' : ''}

IMPORTANT: This moderation must work in ALL languages including English, Telugu, Hindi, and transliterated slang.

REJECT if content contains ANY of:
1. Nudity, sexual content, explicit material
2. Violence, gore, threats
3. Hate speech, discrimination
4. Offensive, vulgar, abusive language in ANY language
5. Content unrelated to campus life
6. Harassment, bullying, or personal attacks
7. Illegal activities or substance abuse

APPROVE if content shows positive campus life.

Respond with JSON only:
{"safe": true_or_false, "reason": "specific reason if rejected, empty string if approved", "category": "approved|nudity|violence|hate_speech|offensive_language|unrelated|harassment"}`,
    });
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      method:'POST', headers:{'Content-Type':'application/json'},
      body: JSON.stringify({ model:'claude-sonnet-4-20250514', max_tokens:300, messages:[{ role:'user', content:msgContent }] }),
    });
  ...
  <Modal transparent visible={visible} animationType="fade" onRequestClose={onClose}>
    <View style={mm.overlay}>
      <View style={mm.card}>
        ...
        <Text style={mm.hint}>Only positive, respectful campus content is allowed. This includes friends, events, academics, sports, and celebrations.</Text>
        <TouchableOpacity onPress={onClose} style={mm.btnWrap} activeOpacity={0.85}>
...
const PostOptionsSheet = ({ visible, isOwn, onClose, onDelete, onEdit }) => {
  ...
  useEffect(() => {
    if (visible) Animated.spring(slideY, { toValue:0, speed:20, bounciness:4, useNativeDriver:true }).start();
    else         Animated.timing(slideY, { toValue:300, duration:220, easing:EASE, useNativeDriver:true }).start();
  }, [visible]);
  ...
  return (
    <Modal transparent animationType="none" onRequestClose={onClose}>
      ...
      <Animated.View style={[po.sheet, { transform:[{ translateY:slideY }] }]}>
        ...
        <TouchableOpacity style={[po.row, { justifyContent:'center' }]} onPress={onClose}>
...
const EditModal = ({ visible, currentDesc, onClose, onSave }) => {
  ...
  useEffect(() => { if (visible) setText(currentDesc); }, [visible, currentDesc]);
  return (
      ...
      <View style={em.overlay}>
        <KeyboardAvoidingView behavior={Platform.OS==='ios'?'padding':undefined} style={{ width:'100%' }}>
          <View style={em.card}>
            ...
            <TextInput style={em.input} value={text} onChangeText={setText} multiline autoFocus maxLength={500} placeholderTextColor="#C7C7C7" />
...
const NewPostModal = ({ visible, onClose, onPost }) => {
  ...
  const TAGS = ['Campus','Friends','Sports','Study Life','Events','Tech','Personal','Food'];

  useEffect(() => {
    if (visible) {
      setDesc(''); setImage(null); setGradIdx(0); setTag('Campus');
      setPosting(false); setModChecking(false); setModError(null);
  ...
  const pickImage = async () => {
    ...
    const res = await ImagePicker.launchImageLibraryAsync({ mediaTypes:ImagePicker.MediaTypeOptions.Images, allowsEditing:true, quality:0.8, aspect:[1,1], base64:true });
    if (res.canceled) return;
    const a = res.assets[0];
    setImage({ uri:a.uri, base64:a.base64, mediaType:a.mimeType||'image/jpeg' });
  };

  const takePhoto = async () => {
    const perm = await ImagePicker.requestCameraPermissionsAsync();
    if (!perm.granted) return;
    const res = await ImagePicker.launchCameraAsync({ allowsEditing:true, quality:0.8, aspect:[1,1], base64:true });
    if (res.canceled) return;
    const a = res.assets[0];
    setImage({ uri:a.uri, base64:a.base64, mediaType:a.mimeType||'image/jpeg' });
  };
  ...
  const handlePost = async () => {
    ...
    setModChecking(true);
    const mod = await moderateContent({ base64Image:image?.base64, mediaType:image?.mediaType, description:desc });
    setModChecking(false);
    if (!mod.safe) { setModError(mod.reason||'This content violates our community guidelines.'); return; }
    setPosting(true);
    setTimeout(() => {
      onPost({ id:`p_${Date.now()}`, author:ME.name, authorRoll:ME.rollNo, avatar:ME.avatar, imageUri:image?.uri??null, gradIdx:image?null:gradIdx, description:desc.trim(), likes:0, liked:false, timeAgo:'Just now', tag, isOwn:true });
      setPosting(false);
      onClose();
    }, 400);
  };
    ...
    <>
      <Modal transparent animationType="none" onRequestClose={onClose}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={{ flex:1 }}>
            <TouchableWithoutFeedback onPress={onClose}><View style={np.overlay} /></TouchableWithoutFeedback>
            <Animated.View style={[np.sheet, { transform:[{ translateY:slideY }] }]}>
              <View style={np.sheetHead}>
                ...
                <View style={np.titleRow}>
                  ...
                  <TouchableOpacity onPress={handlePost} disabled={(!desc.trim()&&!image)||busy}
                    style={[np.shareBtn, ((!desc.trim()&&!image)||busy)&&{ opacity:0.45 }]}>
                    {posting||modChecking
              ...
              <KeyboardAvoidingView behavior={Platform.OS==='ios'?'padding':undefined}>
                <ScrollView style={np.scroll} contentContainerStyle={{ paddingBottom:36 }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                  ...
                  <TextInput style={np.captionInput} placeholder="Write a caption..." placeholderTextColor="#C7C7C7" value={desc} onChangeText={setDesc} multiline maxLength={500} />
                  <Text style={np.charCount}>{desc.length}/500</Text>

                  {image ? (
                    <View style={np.imgWrap}>
                      <Image source={{ uri:image.uri }} style={np.imgPreview} resizeMode="cover" />
                      <TouchableOpacity style={np.imgRemove} onPress={() => setImage(null)}>
                        <View style={np.imgRemoveCircle}><Ionicons name="close" size={16} color="#fff" /></View>
                      </TouchableOpacity>
                    </View>
                  ) : (
                    <View style={np.gradSection}>
                      <Text style={np.sectionLabel}>BACKGROUND COLOR</Text>
                      <LinearGradient colors={GRAD_PALETTES[gradIdx].colors} style={np.gradPreview}>
                        <Text style={np.gradPreviewLabel}>{GRAD_PALETTES[gradIdx].label}</Text>
                      </LinearGradient>
                      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={np.swatchRow}>
                        {GRAD_PALETTES.map((g,i) => (
                          <TouchableOpacity key={i} onPress={() => setGradIdx(i)} style={np.swatchWrap}>
                            <LinearGradient colors={g.colors} style={[np.swatch, gradIdx===i&&np.swatchOn]} />
                            {gradIdx===i && <View style={np.swatchCheck}><Ionicons name="checkmark" size={12} color="#fff" /></View>}
                  ...
                  <View style={np.photoBtnRow}>
                    <TouchableOpacity style={np.photoBtn} onPress={pickImage} activeOpacity={0.8}>
                      <Ionicons name="images-outline" size={18} color="#262626" />
                      <Text style={np.photoBtnTxt}>Gallery</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={np.photoBtn} onPress={takePhoto} activeOpacity={0.8}>
                  ...
                  <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap:8, paddingBottom:4 }}>
                    {TAGS.map(t => (
                      <TouchableOpacity key={t} style={[np.tagChip, tag===t&&np.tagChipOn]} onPress={() => setTag(t)} activeOpacity={0.8}>
                        <Text style={[np.tagChipTxt, tag===t&&np.tagChipTxtOn]}>{t}</Text>
                      </TouchableOpacity>
                    ))}
                  </ScrollView>
                  ...
                  {modChecking && (
                    <View style={np.checkRow}>
                      ...
                      <Text style={np.checkTxt}>AI is reviewing your content...</Text>
                    </View>
                  )}

                  <View style={np.aiNote}>
                    <Ionicons name="sparkles-outline" size={13} color="#8E8E8E" />
                    <Text style={np.aiNoteTxt}>Content is reviewed by AI before posting</Text>
                  </View>
                </ScrollView>
              </KeyboardAvoidingView>
            </Animated.View>
...
const np = StyleSheet.create({
  ...
  shareBtn:        { backgroundColor:C.primary, paddingHorizontal:18, paddingVertical:8, borderRadius:20 },
  ...
  swatchOn:        { width:44, height:44, borderRadius:22, borderWidth:3, borderColor:C.primary },
  swatchCheck:     { position:'absolute', top:0, right:0, width:18, height:18, borderRadius:9, backgroundColor:C.primary, justifyContent:'center', alignItems:'center' },
    ...
    <Animated.View style={[anim, S.card]}>
      ...
      <View style={S.cardHeader}>
        ...
        <View style={{ flex:1 }}>
          ...
          <Text style={S.authorSub}>{post.authorRoll} · {post.timeAgo}</Text>
        </View>
        <View style={S.tagPill}>
          <Text style={S.tagTxt}>#{post.tag}</Text>
        </View>
        <TouchableOpacity onPress={() => onOptions(post)} style={S.dotsBtn} hitSlop={{ top:10, bottom:10, left:10, right:10 }}>
      ...
      {/* Image or gradient */}
      {post.imageUri
        ? <Image source={{ uri:post.imageUri }} style={S.postImg} resizeMode="cover" />
        : (
          <LinearGradient colors={GRAD_PALETTES[post.gradIdx??0].colors} style={S.postGrad}>
      ...
      <View style={S.actionBar}>
        ...
        <TouchableOpacity onPress={handleLike} hitSlop={{ top:8, bottom:8, left:8, right:8 }} activeOpacity={0.8}>
          <Animated.View style={{ transform:[{ scale:heartScale }] }}>
            <Ionicons name={post.liked?'heart':'heart-outline'} size={28} color={post.liked ? C.liked : '#262626'} />
          </Animated.View>
        </TouchableOpacity>
      ...
      {/* Likes count */}
      {post.likes > 0 && (
        <Text style={S.likesLine}>{post.likes.toLocaleString()} {post.likes===1?'like':'likes'}</Text>
      )}
  ...
  const handleDelete = useCallback(() => {
    ...
    Alert.alert('Delete Post', 'Are you sure you want to delete this post?', [
      ...
      { text:'Delete', style:'destructive', onPress:() => {
        setPosts(prev => prev.filter(p => p.id!==optionPost.id));
        setOptionPost(null);
      }},
    ]);
  }, [optionPost]);

  const handleEditSave = useCallback((newDesc) => {
    if (!editPost) return;
    setPosts(prev => prev.map(p => p.id===editPost.id ? { ...p, description:newDesc } : p));
    setEditPost(null);
  }, [editPost]);
    ...
    <View style={S.root}>
      ...
      <Animated.View style={[hAnim, S.header, { paddingTop:SB_H+2 }]}>
        ...
        <View style={S.headerCenter}>
          <LinearGradient colors={[C.primary, C.secondary]} style={S.headerLogo}>
...
const S = StyleSheet.create({
  ...
  header:       { flexDirection:'row', alignItems:'center', justifyContent:'space-between', paddingHorizontal:14, paddingBottom:10, backgroundColor:C.surface, borderBottomWidth:0.5, borderBottomColor:'#DBDBDB' },
  ...
  fab:          { position:'absolute', bottom:28, right:20, shadowColor:C.primary+'60', shadowOffset:{ width:0, height:6 }, shadowOpacity:1, shadowRadius:14, elevation:10 },
