...
// ─────────────────────────────────────────────────────────
//  Component — Screen Shell (shared layout wrapper)
// ─────────────────────────────────────────────────────────
  ...
  const handleReset = async () => {
    ...
    try {
      ...
      Alert.alert(
        ...
        [{
          text:    'Go to Login',
          onPress: async () => { await apiLogout(); navigate('Login'); },
        }],
      );
    } catch (error) {
      setErr(`⚠️  ${error?.message || 'Could not update password.'}`);
    } finally {
      setLoading(false);
    }
  };
...
// ─────────────────────────────────────────────────────────
//  Root Export — ResetPassword (mounts ForceResetScreen)
// ─────────────────────────────────────────────────────────
...
export default function ResetPassword({ navigation, route }) {
  ...
  // Bridge internal navigate() callback onto react-navigation
