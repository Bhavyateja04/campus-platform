...
// Map a backend LostItem document into the local UI shape used by this screen.
function backendItemToUi(it) {
  if (!it || !it._id) return null;
  const postedBy =
    it.postedBy && typeof it.postedBy === "object" ? it.postedBy : null;
  return {
    id: String(it._id),
    type: it.status === "found" ? "found" : "lost",
    personName: postedBy?.name || it.postedByName || "Anonymous",
    rollNo: postedBy?.rollNumber || it.postedByRoll || "",
    phone: it.contactNumber || postedBy?.phone || "",
    ...
    iconIdx: 15,
    urgent: false,
    createdBy: postedBy?.rollNumber || it.postedByRoll || "",
    imageUrl: it.imageUrl || null,
    _matchSuggestions: Array.isArray(it.matchSuggestions)
      ? it.matchSuggestions
      : [],
    _backend: true,
  };
...
// Translate a UI item (from AddForm) into the backend payload shape.
...
const IMG = {
  ...
  umbrella:
    "https://images.unsplash.com/photo-1527540003-4debc444f40f?w=400&q=80",
  idcard:
...
const SEED_LOST = [
  {
    ...
    time: "2h ago",
    date: "13/03/2026",
    desc: 'Left in Study Room 302. Black carrying case with "AM" written inside the lid.',
    iconIdx: 2,
    urgent: true,
    createdBy: "21CSE4501",
  ...
  },
  {
    ...
    time: "1d ago",
    date: "12/03/2026",
    desc: "Brown bifold wallet containing student ID, ATM card and ₹500 cash. Please return urgently.",
    iconIdx: 0,
    urgent: true,
    createdBy: ME.rollNo,
    imageUrl: IMG.wallet,
  },
  {
    ...
    location: "Engineering Block B Restroom",
    time: "5h ago",
    date: "13/03/2026",
    desc: "No screen protector. Lock screen has a mountain range wallpaper.",
    iconIdx: 1,
    urgent: true,
    createdBy: "22ECE3302",
    imageUrl: IMG.phone,
  },
  {
    id: "l04",
    type: "lost",
    personName: "Rohit Kumar",
    rollNo: "21ME2210",
    phone: "9876504567",
    itemName: "North Face Jacket — Black L",
    location: "Athletic Centre Bench",
    time: "2d ago",
    date: "11/03/2026",
    desc: "Black insulated jacket, Size L. Left on the bench outside the gymnasium.",
    iconIdx: 6,
    urgent: false,
    createdBy: "21ME2210",
    imageUrl: IMG.jacket,
  },
  {
    ...
    rollNo: "22EEE5540",
    phone: "9876505678",
    itemName: "Blue Hydro Flask 32oz",
    location: "Science Block B, Room 204",
    time: "4h ago",
    date: "13/03/2026",
    desc: "Blue bottle with a mountain sticker and an Aditya University sticker. 32 oz.",
    iconIdx: 11,
    urgent: false,
    createdBy: "22EEE5540",
    imageUrl: IMG.bottle,
  },
  {
    ...
    time: "6h ago",
    date: "13/03/2026",
    desc: 'Black band Galaxy Watch 5 with a minor scratch on the bezel. "Kavya" engraved on the strap.',
    iconIdx: 9,
    urgent: true,
    createdBy: "22CSE1110",
  ...
  },
  {
    id: "l07",
    type: "lost",
    personName: "Sai Kiran",
    rollNo: "21CSE7890",
    phone: "9876507890",
    itemName: "Dell Inspiron 15 — Silver",
    location: "CS Lab Block A, 2nd Floor",
    time: "3h ago",
    date: "13/03/2026",
    desc: "Silver Dell laptop with blue stickers. Charger also missing. Contains important project files.",
    iconIdx: 5,
    urgent: true,
    createdBy: "21CSE7890",
    imageUrl: IMG.laptop,
  },
  {
    id: "l08",
    type: "lost",
    personName: "Meena Kumari",
    rollNo: "22ME4433",
    phone: "9876508901",
    itemName: "AirPods Pro — White",
    location: "Seminar Hall, Main Block",
    time: "1h ago",
    date: "13/03/2026",
    desc: "White AirPods Pro in a white case. Right earpiece has a small green dot sticker.",
    iconIdx: 14,
    urgent: false,
    createdBy: "22ME4433",
  ...
  },
  {
    id: "l09",
    type: "lost",
    personName: "Aakash Singh",
    rollNo: "22EEE1231",
    phone: "9876509012",
    itemName: "Fossil Chronograph Watch",
    location: "Lab 3, Mechanical Block",
    time: "5d ago",
    date: "08/03/2026",
    desc: 'Brown leather strap, silver dial. "A.S" initials engraved on the back.',
    iconIdx: 9,
    urgent: false,
    createdBy: "22EEE1231",
    imageUrl: IMG.watch,
  },
  {
    id: "l10",
    type: "lost",
    personName: "Pooja Reddy",
    rollNo: "21ECE2200",
    phone: "9876510123",
    itemName: "Dark Green Adidas Backpack",
    location: "Auditorium, Main Block",
    time: "2d ago",
    date: "11/03/2026",
    desc: "Dark green backpack containing notebooks, a charger and a red thermos bottle.",
    iconIdx: 8,
    urgent: false,
    createdBy: "21ECE2200",
  ...
  },
  {
    ...
    rollNo: "22CSE5566",
    phone: "9876511234",
    itemName: "Black Prescription Glasses",
    location: "Library Reading Area, Table 12",
    time: "7h ago",
    date: "13/03/2026",
    desc: "Black rectangular frame glasses with blue-tint lenses. Left at reading table 12.",
    iconIdx: 13,
    urgent: false,
    createdBy: "22CSE5566",
    imageUrl: IMG.glasses,
  },
  {
    id: "l12",
    type: "lost",
    personName: "Swathi Goud",
    rollNo: "22ECE8811",
    phone: "9876512345",
    itemName: "boAt Airdopes 441 — Teal",
    location: "Sports Ground Bleachers",
    time: "3d ago",
    date: "10/03/2026",
    desc: "Teal and black wireless earbuds. Charging case has a crack on the lid.",
    iconIdx: 14,
    urgent: false,
    createdBy: "22ECE8811",
    imageUrl: IMG.earphones,
  },
  {
    id: "l13",
    type: "lost",
    personName: "Tarun Babu",
    rollNo: "21ME9900",
    phone: "9876513456",
    itemName: "Engineering Drawing Set",
    location: "Drawing Hall, Block D",
    time: "1d ago",
    date: "12/03/2026",
    desc: "Pentel stationery set in a blue zip pouch, including a protractor, compass and ruler.",
    iconIdx: 12,
    urgent: false,
    createdBy: "21ME9900",
    imageUrl: IMG.pencilcase,
  },
  {
    id: "l14",
    type: "lost",
    personName: "Hema Latha",
    rollNo: "22CSE3341",
    phone: "9876514567",
    itemName: "Red Collapsible Umbrella",
    location: "Campus Wi-Fi Lounge",
    time: "6h ago",
    date: "13/03/2026",
    desc: "Compact red folding umbrella with slight wear on the handle. Left near the Wi-Fi lounge.",
    iconIdx: 10,
    urgent: false,
    createdBy: "22CSE3341",
  ...
  },
  {
    ...
    location: "Cafeteria, Main Counter Area",
    time: "4h ago",
    date: "13/03/2026",
    desc: "Black over-ear Sony headphones without a case. Last seen near the food counter.",
    iconIdx: 2,
    urgent: true,
    createdBy: "21ME1122",
  ...
  },
  {
    id: "l16",
    type: "lost",
    personName: "Deepa Nair",
    rollNo: "22EEE4499",
    phone: "9876516789",
    itemName: "MacBook MagSafe 67W Charger",
    location: "Block C Study Hall",
    time: "8h ago",
    date: "13/03/2026",
    desc: 'White Apple MagSafe 3 charger (67W). "DN" written in black marker on the brick.',
    iconIdx: 15,
    urgent: false,
    createdBy: "22EEE4499",
...
const SEED_FOUND = [
  {
    ...
    rollNo: "22ECE3105",
    phone: "9876517890",
    itemName: "Keys with Red Keychain",
    location: "Main Gate Security Office",
    time: "1h ago",
    date: "13/03/2026",
    desc: "Three keys with a red keychain and a mini LED torch. Submitted to the main gate security.",
    iconIdx: 3,
    urgent: false,
    createdBy: "22ECE3105",
    imageUrl: IMG.keys,
  },
  {
    ...
    time: "6h ago",
    date: "13/03/2026",
    desc: "Black band watch with a minor screen scratch on the right side. Currently kept with the warden.",
    iconIdx: 9,
    urgent: false,
    createdBy: "21CSE7701",
    imageUrl: IMG.smartwatch,
  },
  {
    ...
    rollNo: "22ME1004",
    phone: "9876519012",
    itemName: "Purple Folding Umbrella",
    location: "CS Lab Block A Entrance",
    time: "2h ago",
    date: "13/03/2026",
    desc: "Compact collapsible purple umbrella with a floral pattern inside. Found near the lab door.",
    iconIdx: 10,
    urgent: false,
    createdBy: "22ME1004",
    imageUrl: IMG.umbrella,
  },
  {
    ...
    rollNo: "21CSE0092",
    phone: "9876520123",
    itemName: "Aditya University Student ID Card",
    location: "Sports Ground, Near Goal Post",
    time: "3h ago",
    date: "13/03/2026",
    desc: "Student ID card found on the ground. Name clearly visible. Submitted to the admin office.",
    iconIdx: 4,
    urgent: false,
    createdBy: "21CSE0092",
    imageUrl: IMG.idcard,
  },
  {
    ...
    rollNo: "22EEE9901",
    phone: "9876521234",
    itemName: "Bose Headphones in Black Case",
    location: "Block C Corridor, Near Rm 204",
    time: "5h ago",
    date: "13/03/2026",
    desc: "Blue Bose headphones in a black case. Found in the corridor. Handed over to the Class Representative.",
    iconIdx: 2,
    urgent: false,
    createdBy: "22EEE9901",
    imageUrl: IMG.headphones,
  },
  {
    id: "f06",
    type: "found",
    personName: "Ravi Teja",
    rollNo: "21CSE3312",
    phone: "9876522345",
    itemName: "Blue Stationery Zip Pouch",
    location: "Library Reading Hall, Table 8",
    time: "8h ago",
    date: "13/03/2026",
    desc: "Blue zip pouch containing a ruler, pens, an eraser and a compass. Placed at the library help desk.",
    iconIdx: 12,
    urgent: false,
    createdBy: "21CSE3312",
    imageUrl: IMG.pencilcase,
  },
  {
    id: "f07",
    type: "found",
    personName: "Harini Devi",
    rollNo: "22CSE2234",
    phone: "9876523456",
    itemName: "Black 65W Laptop Charger",
    location: "CS Lab 2, Block B",
    time: "4h ago",
    date: "13/03/2026",
    desc: "Black laptop charger (65W) found under a desk in Lab 2. Has a yellow sticker on the brick.",
    iconIdx: 15,
    urgent: false,
    createdBy: "22CSE2234",
    imageUrl: IMG.charger,
  },
  {
    id: "f08",
    type: "found",
    personName: "Suresh Babu",
    rollNo: "21ME0045",
    phone: "9876524567",
    itemName: "Matte Black Steel Bottle 1L",
    location: "Gymnasium Entry Area",
    time: "2d ago",
    date: "11/03/2026",
    desc: 'Matte black 1L steel bottle with "SB" initials on the base. Found at the gym entry gate.',
    iconIdx: 11,
    urgent: false,
    createdBy: "21ME0045",
    imageUrl: IMG.bottle,
  },
  {
    ...
    time: "1d ago",
    date: "12/03/2026",
    desc: "Brown bifold wallet containing some cash and an ID card. Found between canteen seats.",
    iconIdx: 0,
    urgent: true,
    createdBy: "22ECE4421",
    imageUrl: IMG.wallet,
  },
  {
    id: "f10",
    type: "found",
    personName: "Pradeep Rao",
    rollNo: "21CSE6677",
    phone: "9876526789",
    itemName: "Apple AirPods Pro — White",
    location: "Library Study Cubicle 7B",
    time: "3h ago",
    date: "13/03/2026",
    desc: "White AirPods Pro in case. Owner name not found nearby. Currently held by the librarian.",
    iconIdx: 14,
    urgent: false,
    createdBy: "21CSE6677",
    imageUrl: IMG.airpods,
  },
  {
    id: "f11",
    type: "found",
    personName: "Chandra Sekhar",
    rollNo: "22ME5532",
    phone: "9876527890",
    itemName: "Black Reading Glasses",
    location: "Reading Room, Library Block",
    time: "5h ago",
    date: "13/03/2026",
    desc: "Black rectangular glasses found on reading table 9. Handed over to the librarian.",
    iconIdx: 13,
    urgent: false,
    createdBy: "22ME5532",
    imageUrl: IMG.glasses,
  },
  {
    id: "f12",
    type: "found",
    personName: "Radha Krishna",
    rollNo: "21EEE3310",
    phone: "9876528901",
    itemName: "Set of 3 Spiral Notebooks",
    location: "Seminar Hall Exit Area",
    time: "6h ago",
    date: "13/03/2026",
    desc: "Three spiral notebooks labelled: Maths, Physics and Chemistry. Found after a seminar. Available at the department office.",
    iconIdx: 7,
    urgent: false,
    createdBy: "21EEE3310",
  ...
  },
  {
    id: "f13",
    type: "found",
    personName: "Pavithra S",
    rollNo: "22CSE7788",
    phone: "9876529012",
    itemName: "Fossil Men's Leather Watch",
    location: "Sports Ground Pavilion",
    time: "1d ago",
    date: "12/03/2026",
    desc: 'Brown strap Fossil watch with "FS" engraved on the back. Found on the pavilion bench.',
    iconIdx: 9,
    urgent: false,
    createdBy: "22CSE7788",
    imageUrl: IMG.watch,
  },
  {
    id: "f14",
    type: "found",
    personName: "Venkat Rao",
    rollNo: "21ME2289",
    phone: "9876530123",
    itemName: "Sony WH-1000XM4 Headphones",
    location: "Block A Rooftop Garden",
    time: "2h ago",
    date: "13/03/2026",
    desc: "Black Sony over-ear headphones near the garden bench. No case. Fully functional.",
    iconIdx: 2,
    urgent: false,
    createdBy: "21ME2289",
    imageUrl: IMG.sonyheadphones,
  },
  {
    id: "f15",
    type: "found",
    personName: "Bhavya Teja",
    rollNo: "22ECE0011",
    phone: "9876531234",
    itemName: "Samsung Galaxy A53 — Blue",
    location: "Workshop Block Exit",
    time: "7h ago",
    date: "13/03/2026",
    desc: "Blue Samsung A53 without a case. Screen locked. Submitted to workshop block security.",
    iconIdx: 1,
    urgent: true,
    createdBy: "22ECE0011",
    imageUrl: IMG.phone,
  },
  {
    ...
    rollNo: "21CSE8899",
    phone: "9876532345",
    itemName: "Navy Blue Adidas Backpack",
    location: "Main Auditorium, Row 12",
    time: "3d ago",
    date: "10/03/2026",
    desc: "Navy blue Adidas backpack with a red logo. Contains books and a charger. Held with security.",
    iconIdx: 8,
    urgent: false,
    createdBy: "21CSE8899",
    imageUrl: IMG.bag,
...
const useCredits = () => {
  _aiCredits = Math.max(0, _aiCredits - 1);
};

// ─── AI HELPERS ───────────────────────────────────────────────────────────────
// Image analysis and AI item verification require an external multimodal LLM
// (e.g. Anthropic Claude). The previous build called api.anthropic.com directly
// from the device WITHOUT an API key, which always returned 401. We now degrade
// gracefully: these helpers return `null` so callers fall back to manual entry,
// while text moderation goes through our backend at /api/moderate/text.

const analyzeImageWithAI = async (_base64Image, _type) => null;
const verifyItemWithAI = async (_args) => null;

const moderateContent = async ({ itemName, description }) => {
...
const AIVerifyModal = ({ item, onClose }) => {
  ...
  const run = async () => {
    if (credits <= 0) {
      setError("You have used all your AI verification credits.");
      return;
    }
    if (!claimDesc.trim()) {
  ...
  const verdictColor = (v) =>
    v === "High" || v === "Likely Owner"
      ? C.green
      : v === "Medium" || v === "Uncertain"
        ? C.gold
        : C.red;
        ...
        <View style={AV.sheet}>
          ...
          <LinearGradient colors={[C.primary, C.primaryDark]} style={AV.header}>
            <View style={{ flex: 1 }}>
              ...
              <Text style={AV.headerSub}>
                Powered by Claude · {credits} credit{credits !== 1 ? "s" : ""}{" "}
                remaining
              </Text>
            </View>
          ...
          >
            ...
            <Text style={AV.hint}>
              Describe the item in detail — colour, brand, any distinguishing
              marks. The AI will match this against the report.
            </Text>
            <TextInput
              style={AV.input}
            ...
            {!result && !loading && (
              ...
              >
                <LinearGradient
                  colors={
                    credits > 0 ? [C.primary, C.primaryDark] : ["#ccc", "#aaa"]
                  }
                  style={AV.runBtn}
                >
                  <Ionicons name="sparkles-outline" size={17} color="#fff" />
                  <Text style={AV.runBtnTxt}>
            ...
            {loading && (
              <View style={AV.loadingBox}>
                ...
                <View>
                  <Text style={AV.loadingTitle}>
                    AI is verifying your claim…
                  </Text>
                  <Text style={AV.loadingSub}>
            ...
            {result && (
              <View style={AV.resultsWrap}>
                ...
                <View
                  style={[
                    AV.verdictBox,
                    { borderColor: verdictColor(result.overallVerdict) },
                  ]}
                >
                  <Text
                    style={[
                  ...
                  <View style={AV.checkHeader}>
                    ...
                    <View
                      style={[
                        ...
                        {
                          backgroundColor:
                            verdictColor(result.imageMatch?.verdict) + "22",
                        },
                      ]}
                    >
                      <Text
                        style={[
                          AV.checkVerdictTxt,
                          { color: verdictColor(result.imageMatch?.verdict) },
                        ]}
                      >
                ...
                <View style={AV.checkCard}>
                  ...
                  <Text style={AV.checkNote}>
                    {result.descriptionSimilarity?.note}
                  </Text>
                </View>
                ...
                <View style={AV.checkCard}>
                  <View style={AV.checkHeader}>
                    ...
                    <View
                      style={[
                        AV.checkVerdict,
                        {
                          backgroundColor: result.duplicateDetection
                            ?.isDuplicate
                            ? C.red + "22"
                            : C.green + "22",
                        },
                    ...
                    >
                      <Text
                        style={[
                          AV.checkVerdictTxt,
                          {
                            color: result.duplicateDetection?.isDuplicate
                              ? C.red
                              : C.green,
                          },
                        ]}
                  ...
                  <Text style={AV.checkNote}>
                    {result.duplicateDetection?.note}
                  </Text>
                </View>

                <Text style={AV.creditsNote}>
                  {getCredits()} AI verification credit
                  {getCredits() !== 1 ? "s" : ""} remaining
                </Text>
              </View>
            )}
          </ScrollView>
        ...
        {FILTER_CATEGORIES.map((fc) => {
          ...
          return (
            <TouchableOpacity
              ...
              style={[
                FM.chip,
                active && { backgroundColor: fc.color, borderColor: fc.color },
              ]}
              onPress={() => {
                onSelect(fc.key);
                onClose();
            ...
            >
              ...
              />
              <Text style={[FM.chipTxt, active && { color: "#fff" }]}>
                {fc.label}
              </Text>
            </TouchableOpacity>
          );
...
const GridCard = ({ item, onPress, delay }) => {
  ...
  return (
    <Animated.View
      style={[
        anim,
        { transform: [...anim.transform, { scale: press }], width: CARD_W },
      ]}
    >
      <TouchableOpacity
        onPressIn={onIn}
      ...
      >
        <View style={G.imageBox}>
          ...
          <View style={G.badgeRow}>
            ...
            {isOwner && (
              <View style={G.youBadge}>
                <Text style={G.youBadgeT}>YOU</Text>
              </View>
            )}
          </View>
          <View
        ...
        <View style={G.info}>
          ...
          <Text style={G.name} numberOfLines={2}>
            {item.itemName}
          </Text>
          <View style={G.locRow}>
            <Ionicons name="location-outline" size={10} color={C.textLight} />
            <Text style={G.locT} numberOfLines={1}>
              {item.location}
            </Text>
          </View>
          <View style={G.metaRow}>
            ...
            <Text style={G.reporter} numberOfLines={1}>
        ...
        {!isOwner ? (
          ...
          >
            <Ionicons
              name={isLost ? "chatbubble-ellipses-outline" : "call-outline"}
              size={12}
              color="#fff"
            />
        ...
        >
          ...
          <View style={ds.heroBox}>
            ...
            <View
              style={[
                ds.typeChip,
                { backgroundColor: isLost ? C.red : C.green },
              ]}
            >
              <Ionicons
                name={isLost ? "alert-circle" : "checkmark-circle"}
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                setShowAIVerify(true);
              }}
              activeOpacity={0.85}
            >
              <LinearGradient
                colors={[C.primary, C.primaryDark]}
                style={ds.aiVerifyGrad}
              >
                <Ionicons name="sparkles-outline" size={16} color="#fff" />
                <View style={{ flex: 1 }}>
                  <Text style={ds.aiVerifyTitle}>AI Item Verification</Text>
                  <Text style={ds.aiVerifySub}>
                    Image match · Description check · Duplicate scan · {credits}{" "}
            ...
            <View style={ds.reporterRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  ...
                  {isOwner && (
                    <View style={ds.youPill}>
                      <Text style={ds.youTxt}>You</Text>
                    </View>
                  )}
                </View>
            ...
            {!!item._matchSuggestions?.length && (
              <View style={ds.matchBox}>
                <View style={ds.matchHead}>
                  <Ionicons
                    name="sparkles-outline"
                    size={16}
                    color={C.primary}
                  />
                  <Text style={ds.matchTitle}>Possible Matches Found</Text>
                </View>
                {item._matchSuggestions.slice(0, 3).map((match) => (
                  <View key={match.id} style={ds.matchRow}>
                    <View style={ds.matchScore}>
                      <Text style={ds.matchScoreTxt}>{match.similarity}%</Text>
                    </View>
                    <View style={{ flex: 1 }}>
                      <Text style={ds.matchName} numberOfLines={1}>
                        {match.itemName}
                      </Text>
                      <Text style={ds.matchMeta} numberOfLines={1}>
                        {match.location} · {match.summary}
                      </Text>
                    </View>
                  </View>
                ))}
            ...
            {!isOwner && item.phone && (
              <View style={ds.contactBox}>
                ...
                >
                  <LinearGradient
                    colors={[C.green, "#146038"]}
                    style={ds.callBtnGrad}
                  >
...
const ds = StyleSheet.create({
  ...
  matchTitle: { fontSize: 13, fontWeight: "800", color: C.primary },
  ...
  matchScoreTxt: { fontSize: 11, fontWeight: "900", color: C.primary },
  matchName: { fontSize: 13, fontWeight: "700", color: C.textDark },
  matchMeta: { fontSize: 11, color: C.textMid, marginTop: 2 },
...
const AddForm = ({ visible, type, onClose, onSubmit }) => {
  ...
  const handleImage = async (asset) => {
    ...
    setModChecking(false);
    if (!mod.safe) {
      setModError(mod.reason || "This image is not permitted.");
      return;
    }
    ...
    if (parsed) {
      ...
      setForm((p) => ({
        ...p,
        itemName: parsed.itemName || p.itemName,
        desc: parsed.description || p.desc,
        location: parsed.suggestedLocation || p.location,
        iconIdx: CAT_IDX[parsed.category] ?? p.iconIdx,
      }));
    }
  };
  ...
  const submit = async () => {
    ...
    setModChecking(false);
    if (!mod.safe) {
      setModError(mod.reason || "Inappropriate content detected.");
      return;
    }
    onSubmit({
      ...form,
    ...
    <Modal transparent animationType="none" onRequestClose={onClose}>
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={{ flex: 1 }}>
          ...
          <Animated.View
            style={[af.sheet, { transform: [{ translateY: slideY }] }]}
          >
            <KeyboardAvoidingView
              ...
              >
                ...
                >
                  <View
                    style={[
                      af.picThumb,
                      { backgroundColor: ICONS[form.iconIdx].bg },
                    ]}
                  >
                    <Ionicons
                      name={ICONS[form.iconIdx].icon}
                      size={20}
                      color={ICONS[form.iconIdx].color}
                    />
                  </View>
                ...
                {showIcons && (
                  <View style={af.iconGrid}>
                    {ICONS.map((ic, i) => (
                      ...
                      >
                        <View
                          style={[af.iconThumb, { backgroundColor: ic.bg }]}
                        >
                          <Ionicons name={ic.icon} size={18} color={ic.color} />
                        </View>
                        <Text style={af.iconLbl} numberOfLines={1}>
                          {ic.label}
                        </Text>
                      </TouchableOpacity>
                    ))}
                ...
                <View style={af.row}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(v) => set("personName", v)}
                    placeholderTextColor={C.textLight}
                  />
                </View>
                ...
                {/* Phone */}
                <Text style={af.lbl}>
                  Contact Number <Text style={{ color: C.red }}>*</Text>
                </Text>
                <View style={af.row}>
                ...
                {/* Item Name */}
                <Text style={af.lbl}>
                  Item Name <Text style={{ color: C.red }}>*</Text>
                </Text>
                <View style={af.row}>
                  ...
                  <TextInput
                    ...
                    placeholder="e.g. Blue Bose Headphones"
                    placeholderTextColor={C.textLight}
                  />
                </View>
                ...
                <View
                  style={[af.row, { alignItems: "flex-start", paddingTop: 12 }]}
                >
                  <Ionicons
                    name="document-text-outline"
                    size={16}
                ...
                <View style={af.imgBtnRow}>
                  ...
                  >
                    <Ionicons
                      ...
                      color={C.primary}
                    />
                    <Text style={af.imgBtnTxt}>Gallery</Text>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={af.imgBtn}
                    onPress={takePhoto}
                  ...
                  >
                    <Ionicons
                      ...
                      color={C.primary}
                    />
                    <Text style={af.imgBtnTxt}>Camera</Text>
                  </TouchableOpacity>
                </View>
                {pickedImage && (
                  <View style={af.prevWrap}>
                    <Image
                ...
                {aiLoading && (
                  <View style={af.aiBox}>
                    <ActivityIndicator size="small" color={C.primary} />
                    <View style={{ flex: 1 }}>
                      <Text style={af.aiTitle}>
                        AI is analysing your image…
                      </Text>
                      <Text style={af.aiSub}>
                        Detecting item, category and description
                      </Text>
                    </View>
                  </View>
                )}
                {aiResult && !aiLoading && (
                  <View style={af.aiResultBox}>
                    <View style={af.aiResultH}>
                      <LinearGradient
                        colors={[C.primary, C.primaryDark]}
                        style={af.aiResultIcon}
                      >
                        <Ionicons name="sparkles" size={13} color="#fff" />
                      </LinearGradient>
                      <Text style={af.aiResultTitle}>AI filled the form!</Text>
                      <TouchableOpacity onPress={() => setAiResult(null)}>
                        <Ionicons name="close" size={16} color={C.textLight} />
                      </TouchableOpacity>
                    </View>
                    <Text style={af.aiResultBody}>
                      Detected:{" "}
                ...
                {modChecking && (
                  <View style={af.modCheckBox}>
                    <ActivityIndicator size="small" color={C.primary} />
                    <Text style={af.modCheckTxt}>Checking content safety…</Text>
                  </View>
                )}
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.87}
                  style={{ marginTop: 14 }}
                  disabled={modChecking || aiLoading}
                >
                  <LinearGradient
                    colors={[C.primary, C.primaryDark]}
                    style={af.submitBtn}
                  >
                    <Ionicons
                      ...
                      color="#fff"
                    />
                    <Text style={af.submitTxt}>Submit Report</Text>
                  </LinearGradient>
                </TouchableOpacity>
              </ScrollView>
            </KeyboardAvoidingView>
      ...
      <Modal
        ...
        visible={!!modError}
        animationType="fade"
        onRequestClose={() => setModError(null)}
      >
        <View style={af.modOverlay}>
          <View style={af.modCard}>
            <View style={af.modIcon}>
              <Ionicons name="shield-checkmark" size={32} color="#fff" />
            </View>
            <Text style={af.modTitle}>Not Permitted</Text>
            <Text style={af.modMsg}>{modError}</Text>
            <TouchableOpacity
              style={af.modBtn}
              onPress={() => setModError(null)}
            >
              <LinearGradient colors={[C.red, "#CC2222"]} style={af.modBtnG}>
                <Text style={af.modBtnT}>Understood</Text>
              </LinearGradient>
            </TouchableOpacity>
          </View>
        </View>
...
const StatsStrip = ({ lostCount, foundCount }) => (
  <View style={SS.strip}>
    {[
      ...
      {
        val: Math.max(0, lostCount - foundCount),
        lbl: "Still Pending",
        color: C.primary,
        icon: "time-outline",
      },
...
export default function LostAndFoundScreen({ navigation }) {
  ...
  const indLeft = tabSlide.interpolate({
    inputRange: [0, 1],
    outputRange: ["2%", "51%"],
  });

  // ── When "I Found It" is tapped: move item from Lost → Found ──
  const handleFoundIt = useCallback(async (item) => {
    if (item._backend) {
      try {
        await lostFoundApi.markFound(item.id);
      } catch (err) {
        console.warn("[LostAndFound] markFound failed:", err?.message || err);
      }
    }
  ...
  const addItem = useCallback(async (item) => {
    ...
    try {
      const result = await lostFoundApi.create(uiItemToBackendPayload(item));
      const created = backendItemToUi({
        ...(result?.data || {}),
        matchSuggestions: result?.matchSuggestions || [],
      });
      if (created) {
        const setter = created.type === "lost" ? setLostItems : setFoundItems;
        setter((prev) => {
          const replaced = prev.map((p) => (p.id === item.id ? created : p));
          if (!replaced.some((p) => p.id === created.id))
      ...
      console.warn(
        "[LostAndFound] backend create failed:",
        err?.message || err,
      );
    }
  }, []);

  // Load real items from backend on mount and merge ahead of seed data.
  useEffect(() => {
    let cancelled = false;
    (async () => {
      try {
        ...
        if (cancelled) return;
        const all = (res?.data || []).map(backendItemToUi).filter(Boolean);
        const lost = all.filter((i) => i.type === "lost");
        const found = all.filter((i) => i.type === "found");
        if (lost.length)
          setLostItems((prev) => [...lost, ...prev.filter((p) => !p._backend)]);
        if (found.length)
          setFoundItems((prev) => [
            ...found,
            ...prev.filter((p) => !p._backend),
          ]);
      } catch (err) {
        console.warn(
          "[LostAndFound] backend fetch failed (using seed data):",
          err?.message || err,
        );
      }
    })();
  ...
  const applyFilter = (items) => {
    ...
    if (activeFilter !== "all") {
      result = result.filter(
        (i) => ICONS[i.iconIdx]?.filterKey === activeFilter,
      );
    }
    return result;
  };
        ...
        <View style={S.listHeader}>
          ...
          >
            <Ionicons
              name="filter-outline"
              size={13}
              color={activeFilter !== "all" ? "#fff" : C.primary}
            />
            <Text
              style={[
                S.filterBtnT,
